<?php
    ...
    foreach ($keywords_arr as $keyword) {
        ...
        $where_clause .= "(nis LIKE '%$keyword%' OR nama LIKE '%$keyword%' OR jenis_kelamin LIKE '%$keyword%' OR kelas LIKE '%$keyword%')";
    }
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Cari Anggota</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Data Anggota</li>
                            <li class="breadcrumb-item active">Cari Anggota</li>
                        ...
                        <div class="row">
                            <!-- layout Search-->
                            <form action="cari_anggota.php" method="GET" class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
                            <div class="col-sm-3 mb-4">
                                <div class="input-group " role="group">
                                    <input class="form-control" name="keyword" type="text" placeholder="Cari Data Anggota" aria-label="Search for..." aria-describedby="btnNavbarSearch" />
            ...
            <div class="card-body text-success">
                <div class="row">
                    <div class="col-md-6 mb-2 ">
                        <a href='daftar_anggota.php' class='btn btn-warning'> Kembali</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="edit_anggota.php?nis=<?=$data['nis']?>" class='btn btn-primary'>Edit</a>
                                <a href="delete_anggota.php?nis=<?=$data['nis']?>" class='btn btn-danger' onclick="return confirm('Apakah anda yakin ingin menghapus ini ?')">Hapus</a>
                            </td>
                        </tr>
                        <?php
                        }
