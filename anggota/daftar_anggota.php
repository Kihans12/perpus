...
<html lang="en">
    <head>
        ...
        function resetData() {
            if (confirm('Apakah Anda yakin ingin mereset semua data?')) {
                window.location.href = 'reset_anggota.php';
            }
        }
        </script>
    </head>
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            ...
            <div class="pe-3">
                <button type="submit" class="btn btn-danger" onclick="resetData()">Reset Data Anggota</button>
            </div>
        </nav>
        <!-- Navbar-->
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0">
                                    <a href='tambah_Anggota.php' class='btn btn-primary'>Tambah Data</a>
                                </form>
