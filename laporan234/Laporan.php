...
if ($_GET['aksi'] == "tanggal_pinjam") {
    ...
    echo "<p style='font-size: 12px;' class='text-center'>" . $row['nama'] . "<br> Email : " . $row['nis'] . " | Nomor Telpon : " . $row['kelas'] . " </p>";
    echo "<hr>";
    ...
    echo "</tr>";
    $no = 1;
    $sql = mysqli_query($koneksi, "SELECT * FROM peminjaman WHERE tanggal_pinjam = '$tgl_pinjam'");
    ...
    echo "</table>";
    echo "<p style='text-align: center;'>Laporan Perpustakaan Berdasarkan Tanggal Peminjaman (" . $_POST['tanggal_pinjam'] . ")</p>";
