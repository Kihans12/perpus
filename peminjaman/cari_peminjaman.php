<?php
    ...
    foreach ($keywords_arr as $keyword) {
        ...
        $where_clause .= "(id_pinjam LIKE '%$keyword%' OR identitas_peminjam LIKE '%$keyword%' OR judul_buku LIKE '%$keyword%' OR tanggal_pinjam LIKE '%$keyword%')";
    }
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Cari Peminjaman</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item active">Data Peminjaman</li>
                            <li class="breadcrumb-item active">Cari Peminjaman</li>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3 mb-4">
                                <div class="input-group " role="group">
                                    <input class="form-control" name="keyword" type="text" placeholder="Cari Data Peminjaman" aria-label="Search for..." aria-describedby="btnNavbarSearch" />
            ...
            <div class="card-body text-success">
                <div class="row">
                    <div class="col-md-6 mb-2 ">
                        <a href='data_peminjaman.php' class='btn btn-warning'> Kembali</a>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="edit_peminjaman.php?id_pinjam=<?=$data['id_pinjam']?>" class='btn btn-primary'>Edit</a>
                                <a href="delete_peminjaman.php?id_pinjam=<?=$data['id_pinjam']?>" class='btn btn-danger' onclick="return confirm('Apakah anda yakin ingin menghapus ini ?')">Hapus</a>
                            </td>
                        </tr>
                        <?php
                        }
