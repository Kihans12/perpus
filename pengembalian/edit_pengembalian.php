            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Edit Data Pengembalian</h1>
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="col-md-6 ">
                                ...
                                <div class="mb-3 mt-3-1">
                                    ...
                                    <input type="number" name="id_pinjam" value="<?= $data['id_pinjam'] ?>" class="form-control" id="id_pinjam"  readonly>
                                </div>

                                <div class="mb-3 mt-3">
                                    <label for="identitas_peminjam" class="form-label">Identitas Peminjam :</label>
                                    <input type="text" name="identitas_peminjam" value="<?= $data['identitas_peminjam'] ?>" class="form-control" id="identitas_peminjam"  readonly>
                                </div>
                                <div class="mb-3">
                                    <label for="judul_buku" class="form-label">Judul Buku :</label>
                                    <input type="text" name="judul_buku" value="<?= $data['judul_buku'] ?>" class="form-control" id="judul_buku"  readonly>
                                </div>
                            ...
                            <div class="col-md-6 ">
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="tanggal_pinjam" value="<?= $data['tanggal_pinjam'] ?>" class="form-control" id="tanggal_pinjam"  readonly>
                                </div>
                                <div class="mb-3">
                                    <label for="jumlah" class="form-label">Jumlah :</label>
                                    <input type="number" name="jumlah" value="<?= $data['jumlah'] ?>" class="form-control" id="jumlah"  readonly>
                                </div>
                                
                                <div class="mb-3">
                                    <label for="tanggal_kembali" class="form-label">Tanggal Kembali :</label>
                                    <input type="text" name="tanggal_kembali" value="<?= $data['tanggal_kembali'] ?>" class="form-control" id="tanggal_kembali" s>
                                </div>
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <a href="data_pengembalian.php" class="btn btn-warning">Kembali</a> <button type="submit" class="btn btn-primary">Perbaharui</button>
                                </div>
                            </form>
                            </div>
                            </div>
