                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-3 mb-4">
                                <div class="input-group " role="group">
                                    <input class="form-control" name="keyword" type="text" placeholder="Cari Data Pengembalian" aria-label="Search for..." aria-describedby="btnNavbarSearch" />
                                                    ...
                                                    <tbody>
                                                        ...
                                                        foreach ($data as $row) { 
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td><?= $row['status'] ?></td>
                                                                <td>
                                                                    <a href="konfirmasi_pengembalian.php?id_pinjam=<?= $row['id_pinjam'] ?>" class='btn btn-success'>Konfirmasi</a>
                                                                    <a href="edit_pengembalian.php?id_pinjam=<?=$row['id_pinjam']?>" class='btn btn-primary'>Edit</a>
                                                                </td>
                                                            </tr>
                                                        <?php } ?>
                                                    </tbody>
